  ...
  \begin{minipage}[c]{\textwidth}
    ...
    \begin{minipage}[b]{.64\textwidth}
      ...
      \only<3>{
        \begin{figure}[c]
          \centering
          \includegraphics[height=5.5cm]{../img/reachview/rtk-settings_content_laptop}
        \end{figure}
      }
      \only<4>{
        \begin{figure}[c]
      ...
      \only<5>{
        \begin{figure}[c]
          \centering
          \includegraphics[height=5.5cm]{../img/reachview/position-output_content_laptop}
        \end{figure}
      }
      \only<6>{
        \begin{figure}[c]
          \centering
          \includegraphics[height=5.5cm]{../img/reachview/base-mode_content_laptop}
        \end{figure}
      }
      \only<7>{
        \begin{figure}[c]
      ...
      \only<8>{
        \begin{figure}[c]
          \centering
          \includegraphics[height=5.5cm]{../img/reachview/camera-control_content_laptop}
        \end{figure}
      }
      \only<9>{
        \begin{figure}[c]
      ...
      \only<10>{
        \begin{figure}[c]
          \centering
          \includegraphics[height=5.5cm]{../img/reachview/settings_content_laptop}
        \end{figure}
      }
    \end{minipage}
  \end{minipage}
