...
\tikzset{
  boat/.pic={
    code={
      ...
      \draw (mast_bottom_left) to[out=-100,in=-145,looseness=1.4] (mast_bottom_right);
      \draw (mast_top_left) to[out=-100,in=-145,looseness=1.2] (mast_top_right);
      \draw (mast_top_left) to[out=45,in=90,looseness=1.0] (mast_top_right);
    }
  }
}
