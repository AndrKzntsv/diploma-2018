  ...
  boat-reversed/.pic={
    code={
      ...
      \draw[fill=white]
        ...
        --
        (stern_right_bottom)
        to[out=-65,in=-165,looseness=0.8]
        (stern_left_bottom)
        --
        (stern_left_top);
      ...
      \draw[fill=white]
        (bow)
        to[out=-135,in=10,looseness=0.8]
        (stern_left_top)
        --
        (stern_left_bottom)
        to[out=10,in=-105,looseness=0.8]
        (bow);
      ...
      \draw[fill=white]
        ...
        --
        (stern_right_top)
        to[out=20,in=180,looseness=0.5]
        (bow);
      ...
      \draw[fill=white]
        ...
        to[out=20,in=-170,looseness=0.4]
        ($ (stern_right_top) + (2.45,0.6) $)
        --
        ($ (stern_left_top) + (2.15,0.8) $)
        to[out=-145,in=10,looseness=0.6]
        ($ (stern_left_top) + (0,0.05) $);
