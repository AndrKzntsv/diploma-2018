...
\tikzset{
  satellite/.pic={
    code={
      ...
      \coordinate (back_top_right) at ($ (face_top_right) + (-1.3,0.5) $);
      \coordinate (back_top_left) at ($ (face_top_left) + (-1.3,0.5) $);
      \coordinate (back_bottom_left) at ($ (face_bottom_left) + (-1.3,0.5) $);
