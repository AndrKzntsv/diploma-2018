...
\tikzset{
  satellite/.pic={
    code={
      ...
      % Right wing
      \coordinate (rw_top_right) at ($ (center) + (2.2,2.3) $);
      \coordinate (rw_bottom_right) at ($ (center) + (1.8,-2.3) $);
      \coordinate (rw_top_left) at ($ (center) + (0.65,2.2) $);
      \coordinate (rw_bottom_left) at ($ (center) + (0.35,-2.4) $);
